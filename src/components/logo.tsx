...
const resolveSize = (s: number | IconSize | undefined, fallback = 20): number =>
  typeof s === "string" ? ICON_SIZES[s] : (s ?? fallback)
...
const LogoMark: React.FC<{
  ...
  return (
    ...
    >
      <g>
        <path d="M87.3,73c-0.4-0.2-1.1-0.4-1.9-0.9c-0.9-0.6-2.5-1.9-4.9-7.3c-1.5-3.3-1.7-4.7-3.2-5.4
        ...
        <path d="M85.9,75.7c0,0-7.5,9.5-27.4,10.6c-0.2,0-0.4,0-0.6,0c-2.5,0.2-7.8,0.3-7.8,0.3s-5.9-0.2-8.1-0.3
        ...
        <path d="M90.5,32.1c-0.1,0.5-0.4,1.2-0.7,2.1c0,0-2.1,5.4-7,10c-4.3,4.1-14.8,9.3-28.5,9.2c-15.5-0.2-29.7-7.4-31.9-14
